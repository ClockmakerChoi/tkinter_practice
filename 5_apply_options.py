...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
        ...
        initialdir=r"C:\Python Practice\tkinter_practice211213\tkinter_practice") # 최초에 사용자가 지정한 경로를 보여줌
...
def merge_image():
    ...
    try:
        ...
        #     y_offset += img.size[1] # height 값 더해줌
